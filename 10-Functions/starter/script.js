...
const poll = {
    ...
    // 1. Method to register a new answer
    registerNewAnswer() {
        // 1.1. Display prompt
        const input = prompt(
            `${this.question}\n${this.options.join('\n')}\n(Write option number)`
        ...
        // 1.2. Validate input and update answers array
        ...
        // 4. Display results after each vote
        this.displayResults();
    },
